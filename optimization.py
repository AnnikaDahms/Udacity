...
def get_optimizer(
    ...
    if optimizer.lower() == "sgd":
        # create an instance of the SGD optimizer. Use the
        # input parameters learning_rate, momentum and weight_decay
        opt = torch.optim.SGD(
            model.parameters(),
            lr=learning_rate,
            momentum=momentum,
        ...
        # create an instance of the Adam optimizer. Use the
        # input parameters learning_rate, momentum and weight_decay
